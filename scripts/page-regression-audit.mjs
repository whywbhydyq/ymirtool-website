...
results.homepage = {
  ...
  hasManifestScript: /ymir-tools-manifest\.js\?v=20260531-v51/.test(index),
  hasDashboardScript: /ymir-home-dashboard\.js\?v=20260531-v51/.test(index),
...
results.loader = {
  versionConstant: /VERSION\s*=\s*["']20260531-v51["']/.test(loader),
...
for (const tool of toolManifest.tools) {
  ...
  const checks = [
    ...
    ['loader-version', html.includes('ymir-vue-loader.js?v=20260531-v51'), {}],
...
for (const page of staticRegistry.pages || []) {
  ...
  const checks = [
    ...
    ['version', html.includes('20260531-v51') || rel === '404.html', {}],
