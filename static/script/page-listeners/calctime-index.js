/* Page-level CSP-safe direct listeners for calctime/index.html. Generated from legacy handlers; do not restore inline handlers. */
(function () {
  'use strict';
  var specs = [{"className":"js-csp-calctime-index-001","events":{"keyup":[{"type":"sanitizeNumeric"}],"afterpaste":[{"type":"sanitizeNumeric"}]}},{"className":"js-csp-calctime-index-002","events":{"keyup":[{"type":"sanitizeNumeric"}],"afterpaste":[{"type":"sanitizeNumeric"}]}},{"className":"js-csp-calctime-index-003","events":{"keyup":[{"type":"sanitizeNumeric"}],"afterpaste":[{"type":"sanitizeNumeric"}]}},{"className":"js-csp-calctime-index-004","events":{"keyup":[{"type":"sanitizeNumeric"}],"afterpaste":[{"type":"sanitizeNumeric"}]}},{"className":"js-csp-calctime-index-005","events":{"keyup":[{"type":"sanitizeNumeric"}],"afterpaste":[{"type":"sanitizeNumeric"}]}},{"className":"js-csp-calctime-index-006","events":{"keyup":[{"type":"sanitizeNumeric"}],"afterpaste":[{"type":"sanitizeNumeric"}]}},{"className":"js-csp-calctime-index-007","events":{"keyup":[{"type":"sanitizeNumeric"}],"afterpaste":[{"type":"sanitizeNumeric"}]}}];
