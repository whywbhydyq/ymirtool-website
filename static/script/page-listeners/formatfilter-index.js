/* Page-level CSP-safe direct listeners for formatfilter/index.html. Do not restore inline handlers. */
(function () {
  'use strict';
  function onReady(fn) {
  ...
  onReady(function () {
    bind(".js-csp-formatfilter-index-001", "click", function (evt, el) { callGlobal("Filter", []); });
    bind(".js-csp-formatfilter-index-002", "click", function (evt, el) { callGlobal("Empty", []); });
  });
}());
