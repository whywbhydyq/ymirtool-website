/* Page-level CSP-safe direct listeners for formatvbs/index.html. Do not restore inline handlers. */
(function () {
  'use strict';
  function onReady(fn) {
  ...
  onReady(function () {
    bind(".js-csp-formatvbs-index-001", "click", function (evt, el) { callGlobal("beautify", []); });
    bind(".js-csp-formatvbs-index-002", "click", function (evt, el) { callGlobal("Empty", []); });
  });
}());
