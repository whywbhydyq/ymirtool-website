/* Page-level CSP-safe direct listeners for json2excel/index.html. Do not restore inline handlers. */
(function () {
  'use strict';
  function onReady(fn) {
  ...
  onReady(function () {
    bind(".js-csp-json2excel-index-001", "mouseover", function (evt, el) { if (el && typeof el.focus === 'function') el.focus(); });
    bind(".js-csp-json2excel-index-002", "click", function (evt, el) { callGlobal("ClearAll", []); });
  });
}());
