/* Page-level CSP-safe direct listeners for formatphp/index.html. Do not restore inline handlers. */
(function () {
  'use strict';
  function onReady(fn) {
  ...
  onReady(function () {
    bind(".js-csp-formatphp-index-001", "click", function (evt, el) { callGlobal("runTabifier", ["PHP"]); });
    bind(".js-csp-formatphp-index-002", "click", function (evt, el) { callGlobal("Empty", []); });
  });
}());
