/* Page-level CSP-safe direct listeners for shaencrypt/index.html. Generated from legacy handlers; do not restore inline handlers. */
(function () {
  'use strict';
  var specs = [{"className":"js-csp-shaencrypt-index-001","events":{"mouseover":[{"type":"focusThis"}]}},{"className":"js-csp-shaencrypt-index-002","events":{"click":[{"type":"call","name":"sha_encrypt","args":[{"kind":"string","value":"sha1"}]}]}},{"className":"js-csp-shaencrypt-index-003","events":{"click":[{"type":"call","name":"sha_encrypt","args":[{"kind":"string","value":"sha256"}]}]}},{"className":"js-csp-shaencrypt-index-004","events":{"click":[{"type":"call","name":"sha_encrypt","args":[{"kind":"string","value":"sha512"}]}]}},{"className":"js-csp-shaencrypt-index-005","events":{"click":[{"type":"call","name":"resetAll","args":[]}]}}];
