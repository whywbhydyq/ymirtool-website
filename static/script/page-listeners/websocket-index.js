/* Page-level CSP-safe direct listeners for websocket/index.html. Generated from legacy handlers; do not restore inline handlers. */
(function () {
  'use strict';
  var specs = [{"className":"js-csp-websocket-index-001","events":{"click":[{"type":"call","name":"addsocket","args":[]}]}},{"className":"js-csp-websocket-index-002","events":{"click":[{"type":"call","name":"closesocket","args":[]}]}},{"className":"js-csp-websocket-index-003","events":{"click":[{"type":"call","name":"Empty","args":[]}]}},{"className":"js-csp-websocket-index-004","events":{"keydown":[{"type":"call","name":"en","args":[{"kind":"event"}]}]}},{"className":"js-csp-websocket-index-005","events":{"click":[{"type":"call","name":"SendMessage","args":[]}]}}];
