/* Page-level CSP-safe direct listeners for shaoshuminzu/index.html. Generated from legacy handlers; do not restore inline handlers. */
(function () {
  'use strict';
  var specs = [{"className":"js-csp-shaoshuminzu-index-001","events":{"submit":[{"type":"tableSearch","tableId":"table_minzu","inputId":"keyword"},{"type":"preventDefault"}]}},{"className":"js-csp-shaoshuminzu-index-002","events":{"click":[{"type":"tableSearch","tableId":"table_minzu","inputId":"keyword"}]}},{"className":"js-csp-shaoshuminzu-index-003","events":{"click":[{"type":"setValueById","id":"keyword","value":""}]}}];
