/* Page-level CSP-safe direct listeners for quanbaojiao/index.html. Generated from legacy handlers; do not restore inline handlers. */
(function () {
  'use strict';
  var specs = [{"className":"js-csp-quanbaojiao-index-001","events":{"mouseover":[{"type":"focusThis"}]}},{"className":"js-csp-quanbaojiao-index-002","events":{"click":[{"type":"call","name":"ToHalf","args":[]}]}},{"className":"js-csp-quanbaojiao-index-003","events":{"click":[{"type":"call","name":"ToFull","args":[]}]}},{"className":"js-csp-quanbaojiao-index-004","events":{"click":[{"type":"call","name":"ClearAll","args":[]}]}}];
