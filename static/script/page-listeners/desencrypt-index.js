/* Page-level CSP-safe direct listeners for desencrypt/index.html. Generated from legacy handlers; do not restore inline handlers. */
(function () {
  'use strict';
  var specs = [{"className":"js-csp-desencrypt-index-001","events":{"mouseover":[{"type":"focusThis"}]}},{"className":"js-csp-desencrypt-index-002","events":{"click":[{"type":"call","name":"encrypt","args":[]}]}},{"className":"js-csp-desencrypt-index-003","events":{"click":[{"type":"call","name":"decrypt","args":[]}]}},{"className":"js-csp-desencrypt-index-004","events":{"click":[{"type":"call","name":"resetAll","args":[]}]}}];
