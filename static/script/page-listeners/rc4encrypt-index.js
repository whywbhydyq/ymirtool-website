/* Page-level CSP-safe direct listeners for rc4encrypt/index.html. Generated from legacy handlers; do not restore inline handlers. */
(function () {
  'use strict';
  var specs = [{"className":"js-csp-rc4encrypt-index-001","events":{"mouseover":[{"type":"focusThis"}]}},{"className":"js-csp-rc4encrypt-index-002","events":{"click":[{"type":"call","name":"encrypt","args":[]}]}},{"className":"js-csp-rc4encrypt-index-003","events":{"click":[{"type":"call","name":"decrypt","args":[]}]}},{"className":"js-csp-rc4encrypt-index-004","events":{"click":[{"type":"call","name":"resetAll","args":[]}]}}];
