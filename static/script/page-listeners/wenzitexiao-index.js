/* Page-level CSP-safe direct listeners for wenzitexiao/index.html. Generated from legacy handlers; do not restore inline handlers. */
(function () {
  'use strict';
  var specs = [{"className":"js-csp-wenzitexiao-index-001","events":{"mouseover":[{"type":"focusThis"}]}},{"className":"js-csp-wenzitexiao-index-002","events":{"click":[{"type":"call","name":"randomise","args":[]},{"type":"preventDefault"}]}},{"className":"js-csp-wenzitexiao-index-003","events":{"click":[{"type":"call","name":"Empty","args":[]}]}}];
