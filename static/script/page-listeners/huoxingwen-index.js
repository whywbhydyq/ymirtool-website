/* Page-level CSP-safe direct listeners for huoxingwen/index.html. Generated from legacy handlers; do not restore inline handlers. */
(function () {
  'use strict';
  var specs = [{"className":"js-csp-huoxingwen-index-001","events":{"mouseover":[{"type":"focusThis"}]}},{"className":"js-csp-huoxingwen-index-002","events":{"click":[{"type":"call","name":"convert","args":[{"kind":"number","value":2}]}]}},{"className":"js-csp-huoxingwen-index-003","events":{"click":[{"type":"call","name":"convert","args":[{"kind":"number","value":0}]}]}},{"className":"js-csp-huoxingwen-index-004","events":{"click":[{"type":"call","name":"ClearAll","args":[]}]}}];
