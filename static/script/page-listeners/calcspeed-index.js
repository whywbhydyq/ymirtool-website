/* Page-level CSP-safe direct listeners for calcspeed/index.html. Generated from legacy handlers; do not restore inline handlers. */
(function () {
  'use strict';
  var specs = [{"className":"js-csp-calcspeed-index-001","events":{"keyup":[{"type":"sanitizeNumeric"}],"afterpaste":[{"type":"sanitizeNumeric"}]}},{"className":"js-csp-calcspeed-index-002","events":{"keyup":[{"type":"sanitizeNumeric"}],"afterpaste":[{"type":"sanitizeNumeric"}]}},{"className":"js-csp-calcspeed-index-003","events":{"keyup":[{"type":"sanitizeNumeric"}],"afterpaste":[{"type":"sanitizeNumeric"}]}},{"className":"js-csp-calcspeed-index-004","events":{"keyup":[{"type":"sanitizeNumeric"}],"afterpaste":[{"type":"sanitizeNumeric"}]}},{"className":"js-csp-calcspeed-index-005","events":{"keyup":[{"type":"sanitizeNumeric"}],"afterpaste":[{"type":"sanitizeNumeric"}]}},{"className":"js-csp-calcspeed-index-006","events":{"keyup":[{"type":"sanitizeNumeric"}],"afterpaste":[{"type":"sanitizeNumeric"}]}},{"className":"js-csp-calcspeed-index-007","events":{"keyup":[{"type":"sanitizeNumeric"}],"afterpaste":[{"type":"sanitizeNumeric"}]}}];
