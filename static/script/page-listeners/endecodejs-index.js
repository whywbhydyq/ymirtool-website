/* Page-level CSP-safe direct listeners for endecodejs/index.html. Do not restore inline handlers. */
(function () {
  'use strict';
  function onReady(fn) {
  ...
  onReady(function () {
    bind(".js-csp-endecodejs-index-001", "click", function (evt, el) { callGlobal("ClearAll", []); });
  });
}());
