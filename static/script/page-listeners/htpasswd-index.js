/* Page-level CSP-safe direct listeners for htpasswd/index.html. Generated from legacy handlers; do not restore inline handlers. */
(function () {
  'use strict';
  var specs = [{"className":"js-csp-htpasswd-index-001","events":{"click":[{"type":"setValueFromCall","targetId":"result","name":"htpasswd","args":[{"kind":"valueById","id":"user"},{"kind":"valueById","id":"pwd1"},{"kind":"numberValueById","id":"alg"}]}]}},{"className":"js-csp-htpasswd-index-002","events":{"click":[{"type":"setValueById","id":"result","value":""}]}},{"className":"js-csp-htpasswd-index-003","events":{"click":[{"type":"focusThis"},{"type":"selectThis"}]}}];
