/* Page-level CSP-safe direct listeners for currency/index.html. Generated from legacy handlers; do not restore inline handlers. */
(function () {
  'use strict';
  var specs = [{"className":"js-csp-currency-index-001","events":{"submit":[{"type":"tableSearch","tableId":"table_huobi","inputId":"keyword"},{"type":"preventDefault"}]}},{"className":"js-csp-currency-index-002","events":{"click":[{"type":"tableSearch","tableId":"table_huobi","inputId":"keyword"}]}},{"className":"js-csp-currency-index-003","events":{"click":[{"type":"setValueById","id":"keyword","value":""}]}}];
