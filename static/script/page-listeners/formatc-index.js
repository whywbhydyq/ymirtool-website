/* Page-level CSP-safe direct listeners for formatc/index.html. Do not restore inline handlers. */
(function () {
  'use strict';
  function onReady(fn) {
  ...
  onReady(function () {
    bind(".js-csp-formatc-index-001", "click", function (evt, el) { callGlobal("runTabifier", ["C语言"]); });
    bind(".js-csp-formatc-index-002", "click", function (evt, el) { callGlobal("Empty", []); });
  });
}());
