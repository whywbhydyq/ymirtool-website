/* Page-level CSP-safe direct listeners for calcangle/index.html. Generated from legacy handlers; do not restore inline handlers. */
(function () {
  'use strict';
  var specs = [{"className":"js-csp-calcangle-index-001","events":{"keyup":[{"type":"sanitizeNumeric"}],"afterpaste":[{"type":"sanitizeNumeric"}]}},{"className":"js-csp-calcangle-index-002","events":{"keyup":[{"type":"sanitizeNumeric"}],"afterpaste":[{"type":"sanitizeNumeric"}]}},{"className":"js-csp-calcangle-index-003","events":{"keyup":[{"type":"sanitizeNumeric"}],"afterpaste":[{"type":"sanitizeNumeric"}]}},{"className":"js-csp-calcangle-index-004","events":{"keyup":[{"type":"sanitizeNumeric"}],"afterpaste":[{"type":"sanitizeNumeric"}]}},{"className":"js-csp-calcangle-index-005","events":{"keyup":[{"type":"sanitizeNumeric"}],"afterpaste":[{"type":"sanitizeNumeric"}]}},{"className":"js-csp-calcangle-index-006","events":{"keyup":[{"type":"sanitizeNumeric"}],"afterpaste":[{"type":"sanitizeNumeric"}]}},{"className":"js-csp-calcangle-index-007","events":{"keyup":[{"type":"sanitizeNumeric"}],"afterpaste":[{"type":"sanitizeNumeric"}]}},{"className":"js-csp-calcangle-index-008","events":{"keyup":[{"type":"sanitizeNumeric"}],"afterpaste":[{"type":"sanitizeNumeric"}]}}];
