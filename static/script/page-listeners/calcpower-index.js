/* Page-level CSP-safe direct listeners for calcpower/index.html. Generated from legacy handlers; do not restore inline handlers. */
(function () {
  'use strict';
  var specs = [{"className":"js-csp-calcpower-index-001","events":{"keyup":[{"type":"sanitizeNumeric"}],"afterpaste":[{"type":"sanitizeNumeric"}]}},{"className":"js-csp-calcpower-index-002","events":{"keyup":[{"type":"sanitizeNumeric"}],"afterpaste":[{"type":"sanitizeNumeric"}]}},{"className":"js-csp-calcpower-index-003","events":{"keyup":[{"type":"sanitizeNumeric"}],"afterpaste":[{"type":"sanitizeNumeric"}]}},{"className":"js-csp-calcpower-index-004","events":{"keyup":[{"type":"sanitizeNumeric"}],"afterpaste":[{"type":"sanitizeNumeric"}]}},{"className":"js-csp-calcpower-index-005","events":{"keyup":[{"type":"sanitizeNumeric"}],"afterpaste":[{"type":"sanitizeNumeric"}]}},{"className":"js-csp-calcpower-index-006","events":{"keyup":[{"type":"sanitizeNumeric"}],"afterpaste":[{"type":"sanitizeNumeric"}]}},{"className":"js-csp-calcpower-index-007","events":{"keyup":[{"type":"sanitizeNumeric"}],"afterpaste":[{"type":"sanitizeNumeric"}]}},{"className":"js-csp-calcpower-index-008","events":{"keyup":[{"type":"sanitizeNumeric"}],"afterpaste":[{"type":"sanitizeNumeric"}]}},{"className":"js-csp-calcpower-index-009","events":{"keyup":[{"type":"sanitizeNumeric"}],"afterpaste":[{"type":"sanitizeNumeric"}]}}];
