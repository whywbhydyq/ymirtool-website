/* Page-level CSP-safe direct listeners for ascii/index.html. Generated from legacy handlers; do not restore inline handlers. */
(function () {
  'use strict';
  var specs = [{"className":"js-csp-ascii-index-001","events":{"mouseover":[{"type":"focusThis"}]}},{"className":"js-csp-ascii-index-002","events":{"click":[{"type":"call","name":"a","args":[{"kind":"string","value":"CONVERT_FMT3"}]}]}},{"className":"js-csp-ascii-index-003","events":{"click":[{"type":"call","name":"a","args":[{"kind":"string","value":"RECONVERT"}]}]}},{"className":"js-csp-ascii-index-004","events":{"click":[{"type":"call","name":"ClearAll","args":[]}]}}];
