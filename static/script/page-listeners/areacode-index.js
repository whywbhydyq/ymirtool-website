/* Page-level CSP-safe direct listeners for areacode/index.html. Generated from legacy handlers; do not restore inline handlers. */
(function () {
  'use strict';
  var specs = [{"className":"js-csp-areacode-index-001","events":{"submit":[{"type":"tableSearch","tableId":"table_quhao","inputId":"keyword"},{"type":"preventDefault"}]}},{"className":"js-csp-areacode-index-002","events":{"click":[{"type":"tableSearch","tableId":"table_quhao","inputId":"keyword"}]}},{"className":"js-csp-areacode-index-003","events":{"click":[{"type":"setValueById","id":"keyword","value":""}]}}];
