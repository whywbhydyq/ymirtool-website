/* Page-level CSP-safe direct listeners for html2all/index.html. Generated from legacy handlers; do not restore inline handlers. */
(function () {
  'use strict';
  var specs = [{"className":"js-csp-html2all-index-001","events":{"click":[{"type":"call","name":"htmlCov","args":[{"kind":"string","value":"asp"}]}]}},{"className":"js-csp-html2all-index-002","events":{"click":[{"type":"call","name":"htmlCov","args":[{"kind":"string","value":"vbnet"}]}]}},{"className":"js-csp-html2all-index-003","events":{"click":[{"type":"call","name":"htmlCov","args":[{"kind":"string","value":"perl"}]}]}},{"className":"js-csp-html2all-index-004","events":{"click":[{"type":"call","name":"htmlCov","args":[{"kind":"string","value":"sws"}]}]}},{"className":"js-csp-html2all-index-005","events":{"click":[{"type":"call","name":"Empty","args":[]}]}}];
