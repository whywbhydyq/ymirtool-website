/* Page-level CSP-safe direct listeners for morse/index.html. Do not restore inline handlers. */
(function () {
  'use strict';
  function onReady(fn) {
  ...
  onReady(function () {
    bind(".js-csp-morse-index-001", "click", function (evt, el) { callGlobal("encode_morse_zh", []); });
    bind(".js-csp-morse-index-002", "click", function (evt, el) { callGlobal("decode_morse_zh", []); });
    bind(".js-csp-morse-index-003", "click", function (evt, el) { callGlobal("ClearAll", []); });
  });
}());
