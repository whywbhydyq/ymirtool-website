/* Page-level CSP-safe direct listeners for xpath/index.html. Generated from legacy handlers; do not restore inline handlers. */
(function () {
  'use strict';
  var specs = [{"className":"js-csp-xpath-index-001","events":{"click":[{"type":"call","name":"find","args":[{"kind":"number","value":1}]}]}},{"className":"js-csp-xpath-index-002","events":{"click":[{"type":"call","name":"find","args":[{"kind":"number","value":3}]}]}},{"className":"js-csp-xpath-index-003","events":{"click":[{"type":"call","name":"find","args":[{"kind":"number","value":2}]}]}},{"className":"js-csp-xpath-index-004","events":{"click":[{"type":"call","name":"demo","args":[]}]}},{"className":"js-csp-xpath-index-005","events":{"click":[{"type":"call","name":"ClearAll","args":[]}]}}];
