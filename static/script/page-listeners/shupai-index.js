/* Page-level CSP-safe direct listeners for shupai/index.html. Generated from legacy handlers; do not restore inline handlers. */
(function () {
  'use strict';
  var specs = [{"className":"js-csp-shupai-index-001","events":{"mouseover":[{"type":"focusThis"}]}},{"className":"js-csp-shupai-index-002","events":{"click":[{"type":"call","name":"cbig5","args":[]}]}},{"className":"js-csp-shupai-index-003","events":{"click":[{"type":"call","name":"h","args":[]}]}},{"className":"js-csp-shupai-index-004","events":{"click":[{"type":"call","name":"Empty","args":[]}]}},{"className":"js-csp-shupai-index-005","events":{"mouseover":[{"type":"focusThis"}]}}];
