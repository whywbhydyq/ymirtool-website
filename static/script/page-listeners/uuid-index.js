/* Page-level CSP-safe direct listeners for uuid/index.html. Generated from legacy handlers; do not restore inline handlers. */
(function () {
  'use strict';
  var specs = [{"className":"js-csp-uuid-index-001","events":{"click":[{"type":"call","name":"ip2long","args":[]}]}},{"className":"js-csp-uuid-index-002","events":{"click":[{"type":"emptyById","id":"result"}]}}];
