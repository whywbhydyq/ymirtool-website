/* Page-level CSP-safe direct listeners for enlower/index.html. Generated from legacy handlers; do not restore inline handlers. */
(function () {
  'use strict';
  var specs = [{"className":"js-csp-enlower-index-001","events":{"mouseover":[{"type":"focusThis"}]}},{"className":"js-csp-enlower-index-002","events":{"click":[{"type":"call","name":"en_convert","args":[{"kind":"number","value":1}]}]}},{"className":"js-csp-enlower-index-003","events":{"click":[{"type":"call","name":"en_convert","args":[{"kind":"number","value":2}]}]}},{"className":"js-csp-enlower-index-004","events":{"click":[{"type":"setValueById","id":"content","value":""},{"type":"focusById","id":"content"}]}}];
