/* Page-level CSP-safe direct listeners for camelcase/index.html. Generated from legacy handlers; do not restore inline handlers. */
(function () {
  'use strict';
  var specs = [{"className":"js-csp-camelcase-index-001","events":{"click":[{"type":"call","name":"convertCamelCase","args":[{"kind":"number","value":2}]}]}},{"className":"js-csp-camelcase-index-002","events":{"click":[{"type":"call","name":"convertCamelCase","args":[{"kind":"number","value":1}]}]}},{"className":"js-csp-camelcase-index-003","events":{"click":[{"type":"call","name":"demo","args":[]}]}},{"className":"js-csp-camelcase-index-004","events":{"click":[{"type":"call","name":"ClearAll","args":[]}]}}];
