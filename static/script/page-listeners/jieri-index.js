/* Page-level CSP-safe direct listeners for jieri/index.html. Generated from legacy handlers; do not restore inline handlers. */
(function () {
  'use strict';
  var specs = [{"className":"js-csp-jieri-index-001","events":{"submit":[{"type":"tableSearch","tableId":"table_jieri","inputId":"keyword"},{"type":"preventDefault"}]}},{"className":"js-csp-jieri-index-002","events":{"click":[{"type":"tableSearch","tableId":"table_jieri","inputId":"keyword"}]}},{"className":"js-csp-jieri-index-003","events":{"click":[{"type":"setValueById","id":"keyword","value":""}]}}];
