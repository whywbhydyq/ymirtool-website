/* Page-level CSP-safe direct listeners for capital/index.html. Generated from legacy handlers; do not restore inline handlers. */
(function () {
  'use strict';
  var specs = [{"className":"js-csp-capital-index-001","events":{"submit":[{"type":"tableSearch","tableId":"table_shoudu","inputId":"keyword"},{"type":"preventDefault"}]}},{"className":"js-csp-capital-index-002","events":{"click":[{"type":"tableSearch","tableId":"table_shoudu","inputId":"keyword"}]}},{"className":"js-csp-capital-index-003","events":{"click":[{"type":"setValueById","id":"keyword","value":""}]}}];
