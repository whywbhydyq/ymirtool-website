/* Page-level CSP-safe direct listeners for jianfan/index.html. Generated from legacy handlers; do not restore inline handlers. */
(function () {
  'use strict';
  var specs = [{"className":"js-csp-jianfan-index-001","events":{"mouseover":[{"type":"focusThis"}]}},{"className":"js-csp-jianfan-index-002","events":{"click":[{"type":"call","name":"convert","args":[{"kind":"number","value":0}]}]}},{"className":"js-csp-jianfan-index-003","events":{"click":[{"type":"call","name":"convert","args":[{"kind":"number","value":1}]}]}},{"className":"js-csp-jianfan-index-004","events":{"click":[{"type":"call","name":"ClearAll","args":[]}]}}];
