/* Page-level CSP-safe direct listeners for calcthickness/index.html. Generated from legacy handlers; do not restore inline handlers. */
(function () {
  'use strict';
  var specs = [{"className":"js-csp-calcthickness-index-001","events":{"keyup":[{"type":"sanitizeNumeric"}],"afterpaste":[{"type":"sanitizeNumeric"}]}},{"className":"js-csp-calcthickness-index-002","events":{"keyup":[{"type":"sanitizeNumeric"}],"afterpaste":[{"type":"sanitizeNumeric"}]}},{"className":"js-csp-calcthickness-index-003","events":{"keyup":[{"type":"sanitizeNumeric"}],"afterpaste":[{"type":"sanitizeNumeric"}]}},{"className":"js-csp-calcthickness-index-004","events":{"keyup":[{"type":"sanitizeNumeric"}],"afterpaste":[{"type":"sanitizeNumeric"}]}},{"className":"js-csp-calcthickness-index-005","events":{"keyup":[{"type":"sanitizeNumeric"}],"afterpaste":[{"type":"sanitizeNumeric"}]}},{"className":"js-csp-calcthickness-index-006","events":{"keyup":[{"type":"sanitizeNumeric"}],"afterpaste":[{"type":"sanitizeNumeric"}]}}];
