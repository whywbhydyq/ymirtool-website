/* Page-level CSP-safe direct listeners for formatcpp/index.html. Do not restore inline handlers. */
(function () {
  'use strict';
  function onReady(fn) {
  ...
  onReady(function () {
    bind(".js-csp-formatcpp-index-001", "click", function (evt, el) { callGlobal("runTabifier", ["C++"]); });
    bind(".js-csp-formatcpp-index-002", "click", function (evt, el) { callGlobal("Empty", []); });
  });
}());
