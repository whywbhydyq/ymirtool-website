/* Page-level CSP-safe direct listeners for urlcode/index.html. Do not restore inline handlers. */
(function () {
  'use strict';
  function onReady(fn) {
  ...
  onReady(function () {
    bind(".js-csp-urlcode-index-001", "click", function (evt, el) { callGlobal("urlCrypt", []); });
    bind(".js-csp-urlcode-index-002", "click", function (evt, el) { callGlobal("ClearAll", []); });
  });
}());
