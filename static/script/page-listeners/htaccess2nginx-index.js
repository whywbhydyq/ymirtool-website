/* Page-level CSP-safe direct listeners for htaccess2nginx/index.html. Do not restore inline handlers. */
(function () {
  'use strict';
  function onReady(fn) {
  ...
  onReady(function () {
    bind(".js-csp-htaccess2nginx-index-001", "click", function (evt, el) { callGlobal("htaccess2nginx", [1]); });
    bind(".js-csp-htaccess2nginx-index-002", "click", function (evt, el) { callGlobal("ClearAll", []); });
  });
}());
