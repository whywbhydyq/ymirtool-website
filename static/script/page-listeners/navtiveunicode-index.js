/* Page-level CSP-safe direct listeners for navtiveunicode/index.html. Generated from legacy handlers; do not restore inline handlers. */
(function () {
  'use strict';
  var specs = [{"className":"js-csp-navtiveunicode-index-001","events":{"mouseover":[{"type":"focusThis"}]}},{"className":"js-csp-navtiveunicode-index-002","events":{"click":[{"type":"call","name":"Native2Unicode","args":[]}]}},{"className":"js-csp-navtiveunicode-index-003","events":{"click":[{"type":"call","name":"Unicode2Native","args":[]}]}},{"className":"js-csp-navtiveunicode-index-004","events":{"click":[{"type":"call","name":"ClearAll","args":[]}]}}];
